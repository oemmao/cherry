...
<?php
	...
	if ($row['cmtCount'] == 0) {
		...
		$sql_cmt = "select comment_id, name, commentDate, comment, cmt_reply from comment_test where board_num='$num' order by cmt_reply desc limit $start_cmt_num, $cmt_list";
